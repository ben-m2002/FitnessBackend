...
public class WorkoutService extends com.example.fitnessbackend.service.Service {
    ...
    public AllUserWSResponseDto getAllUserWorkoutSessions(){
        ...
        List<WorkoutSession> workoutSessions = workoutSessionRepository.findWorkoutSessionByUser(userModel);
    ...
    public WorkoutSessionResponseDto updateWorkoutSession(WorkoutUpdateRequestDto dto){
        ...
        return workoutSessionMapper.toWSResponseDto(newSavedSession, "Workout session updated successfully");
    }
    ...
    public AllWEResponseDto getAllUserWorkoutExercises(){
        ...
        return workoutExerciseMapper.toAllUserWorkoutExerciseResponseDto("All workout exercises retrieved successfully",
                workoutExercises);
    }
